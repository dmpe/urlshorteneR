#' Query whether a given domain is a valid bitly pro domain. Keep in mind that bitly custom short domains are 
#' restricted to less than 15 characters in length.
#'
