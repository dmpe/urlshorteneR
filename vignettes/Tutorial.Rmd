...
bitly_token <- bitly_auth(key = "be03aead58f23bc1aee6e1d7b7a1d99d62f0ede8", secret = "e12dfc2482c76512b9a497e965abf4e082d1ffeb")
...
```{r}
vd_LinksShorten(longUrl = "http://cbs.com/", showRequestURL = TRUE)
```
