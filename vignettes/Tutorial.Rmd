...
In order to begin shortening URLs and downloading useful statistics about short links, you have to -- in the case of <https://bit.ly> -- authenticate using OAuth2.0. 

For [is.gd](https://is.gd/) and [v.gd](https://v.gd/) there is no authentication needed. Just create desired short links, see below.
